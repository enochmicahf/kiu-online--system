...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- Page Content -->
        <div id="content">
            <nav class="navbar navbar-top navbar-expand-lg d-flex justify-content-between align-items-center">
                <button type="button" id="sidebarCollapse" class="btn btn-outline-primary d-md-none">
                    <i class="fas fa-bars"></i>
                </button>
                <h5 class="mb-0 d-none d-md-block"><?php echo $page_title; ?></h5>
                <div class="user-info d-flex align-items-center">
                    <span class="me-3 text-muted">Welcome, <strong><?php echo $_SESSION['username']; ?></strong></span>
